                ...
                >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full cursor-pointer rounded-xl border border-dashed border-orange-500/50 bg-[#FDEEE7] p-2 text-gray-300 file:mr-4 file:rounded-lg file:border-0 file:bg-orange-600 file:px-4 file:py-2 file:text-white file:cursor-pointer hover:file:bg-orange-600"
                        />
                    </div>
                    ...
                    <button
                        type="submit"
                        className="mt-2 rounded-2xl bg-[#ff5100]  py-1.5 cursor-pointer text-lg font-semibold text-white shadow-lg transition-all duration-300 hover:scale-[1.02] hover:from-orange-700 hover:to-orange-600 hover:shadow-orange-500/40"
                    >
                        Create Reel
                    </button>
                </form>
